...
class PromptEvaluator:
    ...
    def _evaluate_coherence(
        ...
        response_lower = response.lower()
        flow_indicator_count = sum(1 for indicator in flow_indicators if indicator in response_lower)
    ...
    def _evaluate_completeness(
        ...
        if query and any(re.search(pattern, response_lower, re.IGNORECASE) for pattern in actionable_patterns):
