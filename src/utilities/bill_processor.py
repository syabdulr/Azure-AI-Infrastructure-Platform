...
class BillData(BaseModel):
    ...
    payment_history: Optional[List[Dict[str, Any]]] = Field(None, description="Previous payment history")
...
class BillProcessor:
    ...
    async def compare_bills(
        ...
        comparison = {
            "billing_period_days": (
                (bill_b.billing_period_end - bill_b.billing_period_start).days
            ),
    ...
    async def detect_anomalies(
        self,
        bill: BillData,
        historical_bills: List[BillData]
    ) -> List[BillInsight]:
        """
