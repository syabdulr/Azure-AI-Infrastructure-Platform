...
class Settings(BaseSettings):
    ...
    app_name: str = Field(
        default="Azure AI Infrastructure Platform", description="Application name"
    )
    ...
    azure_openai_api_key: Optional[str] = Field(
        None, description="Azure OpenAI API key (managed from Key Vault)"
    )
    ...
    azure_search_endpoint: Optional[str] = Field(
        None, description="Azure Cognitive Search endpoint URL"
    )
    ...
    azure_search_api_key: Optional[str] = Field(
        None, description="Azure Search API key (managed from Key Vault)"
    )
    ...
    azure_storage_connection_string: Optional[str] = Field(
        None, description="Storage connection string (managed from Key Vault)"
    )
    ...
    azure_app_insights_instrumentation_key: Optional[str] = Field(
    ...
    gpt4_input_cost_per_1k: float = Field(
        default=0.03, description="GPT-4 input cost per 1K tokens"
    )
    gpt4_output_cost_per_1k: float = Field(
        default=0.06, description="GPT-4 output cost per 1K tokens"
    )
