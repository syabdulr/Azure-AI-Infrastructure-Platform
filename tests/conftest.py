...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "azure: Tests requiring Azure services")
...
def mock_cognitive_search_client():
    ...
    client.search.return_value = [
        MagicMock(
            id="doc-1", title="Test Document", content="Test content for searching", score=0.95
        ),
        MagicMock(id="doc-2", title="Another Document", content="More test content", score=0.85),
    ]
...
def sample_document() -> Dict[str, Any]:
    ...
    return {
        ...
        "metadata": {"author": "Abdul Syed", "category": "documentation"},
    }
...
def sample_documents() -> list:
    ...
    return [
        {"title": "Document 1", "content": "Content for document 1", "source": "/docs/doc1.md"},
        {"title": "Document 2", "content": "Content for document 2", "source": "/docs/doc2.md"},
        {"title": "Document 3", "content": "Content for document 3", "source": "/docs/doc3.md"},
    ]
...
def sample_metrics() -> Dict[str, Any]:
    ...
    return {
        "counters": {"api_requests_total": {"value": 1000}, "ai_requests_total": {"value": 500}},
        "gauges": {"active_connections": {"value": 50}, "ai_error_rate": {"value": 0.05}},
        "histograms": {
        ...
        "summaries": {
            "api_response_time_ms": {
                "count": 1000,
                "sum": 50000,
                "quantiles": {"0.5": 45, "0.9": 95, "0.95": 120, "0.99": 200},
            }
        },
    }
...
def sample_alert() -> Dict[str, Any]:
    ...
    return {
        ...
        "severity": "critical",
        "context": {"metric": "ai_error_rate", "condition": "gt"},
    ...
    return [
        {
            ...
            "source": "api",
            "context": {"endpoint": "/chat", "user_id": "user-123"},
        },
        {
            ...
            "source": "guardrails",
            "context": {"user_id": "user-123", "remaining": 5},
        },
        {
...
def create_test_user(
    user_id: str = "test-user-123", email: str = "test@example.com"
) -> Dict[str, Any]:
