...
from src.monitoring.alert_manager import Alert, AlertManager, AlertRule
...
class TestAlert:
    ...
    def test_alert_resolve(self):
        ...
        alert = Alert(
            rule_name="test_rule", value=0.95, threshold=0.9, message="Test alert", severity="high"
        )
...
class TestAlertManager:
    ...
    def test_alert_manager_trigger_manual_alert(self):
        ...
        alert = manager.trigger_alert(
            rule_name="custom_rule", value=0.95, message="Manual test alert", severity="medium"
        )
    ...
    def test_alert_manager_resolve_alert(self):
        ...
        alert = manager.trigger_alert(
            rule_name="custom_rule", value=0.95, message="Test alert", severity="medium"
        )
    ...
    def test_alert_manager_get_alerts(self):
        ...
        # Trigger some alerts
        manager.trigger_alert(rule_name="rule1", value=0.95, message="Alert 1", severity="high")

        manager.trigger_alert(rule_name="rule2", value=0.85, message="Alert 2", severity="medium")
