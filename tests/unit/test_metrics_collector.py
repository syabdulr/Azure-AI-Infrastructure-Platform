...
from src.monitoring.metrics_collector import Counter, Gauge, Histogram, MetricsCollector, Summary
...
class TestMetricsCollector:
    ...
    def test_metrics_collector_create_histogram(self):
        ...
        collector = MetricsCollector()
        histogram = collector.create_histogram("custom_histogram", [1, 5, 10], "Custom histogram")
    ...
    def test_metrics_collector_create_summary(self):
        ...
        collector = MetricsCollector()
        summary = collector.create_summary("custom_summary", [0.5, 0.9], "Custom summary")
